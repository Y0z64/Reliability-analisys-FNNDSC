...
for split in splits:
    ...
    if seg_model5label_path is None:
        raise FileNotFoundError(f"No 5-label model segmentation file found. Tried:\n" + 
...
# Plot SP Model
sp_path_func = lambda current_path: os.path.join(current_path, f"segmentations/{subject_id}_{session_id}_nuc_deep_subplate_dilate_mc.nii")
